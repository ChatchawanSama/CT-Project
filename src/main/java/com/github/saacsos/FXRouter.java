...
public final class FXRouter {
    ...
    private static final AbstractMap<String, RouteScene> routes = new HashMap();
    ...
    public static void goTo(String routeLabel, Object data, double winWidth, double winHeight) throws IOException {
        RouteScene route = routes.get(routeLabel);
        route.sceneHeight = winHeight;
        route.sceneWidth = winWidth;
        route.data = data;
        loadNewRoute(route);
    }

    public static void goToWithPosition(String routeLabel, Object data, double x, double y) throws IOException {
        RouteScene route = routes.get(routeLabel);
        window.setX(x);
        window.setY(y);
        route.data = data;
    ...
    public static void goToWithPosition(String routeLabel, Object data, double winWidth, double winHeight, double x, double y) throws IOException {
        RouteScene route = routes.get(routeLabel);
        route.sceneHeight = winHeight;
        route.sceneWidth = winWidth;
        window.setX(x);
